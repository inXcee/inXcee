...
const G_NAV = {
  ...
  f: { path: '/settings/companies', label: 'Firmalar' },
  v: { path: '/settings/visitors', label: 'Ziyaretçiler' },
  s: { path: '/settings/surveys', label: 'Memnuniyet' },
  t: { path: '/settings/drills', label: 'Tatbikatlar' },
  p: { path: '/settings/documents', label: 'Belgeler' },
  e: { path: '/settings/expenses', label: 'Bütçe' },
  a: { path: '/settings/automation', label: 'Otomasyon' },
