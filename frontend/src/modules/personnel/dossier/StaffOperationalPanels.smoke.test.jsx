...
import { StaffPerformancePanel, StaffSafetyPanel, StaffEquipmentPanel } from './StaffOperationalPanels.jsx'
...
describe('StaffOperationalPanels smoke', () => {
  beforeEach(() => {
    ...
    api.get.mockImplementation(url => {
      ...
      if (url.includes('/performance/positive')) return Promise.resolve({ data: [{ id: 3, reason: 'Fazla mesai', points: 2 }] })
